...
## Выводы
  ...
  Так же стоит заметить, что на данный момент существуют более эффективные методы классифификации, так кроме сервиса для анализа эмоций на лице, когнитивные сервисы компании Microsoft также предлагают возможности по анализу естественных языков.
